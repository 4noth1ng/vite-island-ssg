import { a as lt, c as qa } from './chunk-R5VAPCHT.js';
var Lu = lt((td, zu) => {
  'use strict';
  zu.exports = qa();
});
var Vu = lt((L) => {
  ...
  var Tu,
    ...
    Fu = typeof clearTimeout == 'function' ? clearTimeout : null,
    Du = typeof setImmediate < 'u' ? setImmediate : null;
  typeof navigator < 'u' &&
  ...
  function Sl(e, n) {
    (mn = !1), ut && ((ut = !1), Fu(ot), (ot = -1)), (bt = !0);
    var t = G;
    try {
      for (
        wl(n), me = Se(Le);
        me !== null && (!(me.expirationTime > n) || (e && !Uu()));
    ...
    return (
      ...
      t > r
        ? ((e.sortIndex = t),
          ...
          Se(Le) === null &&
            e === Se(Ke) &&
            (ut ? (Fu(ot), (ot = -1)) : (ut = !0), Cl(kl, t - r)))
        : ((e.sortIndex = l), gl(Le, e), mn || bt || ((mn = !0), El(Sl))),
      e
    );
  };
  L.unstable_shouldYield = Uu;
...
var Xa = lt((pe) => {
  ...
  function Gn(e, n) {
    for (Lt[e] = n, e = 0; e < n.length; e++) Zo.add(n[e]);
  }
  var Ae = !(
      typeof window > 'u' ||
  ...
  var We = Go.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
  ...
  var bo = Symbol.for('react.offscreen');
...
` + l[u].replace(' at new ', ' at ');
  ...
  function ti(e, n) {
    if (n) {
      if (sc[e] && (n.children != null || n.dangerouslySetInnerHTML != null))
        throw Error(h(137, e));
  ...
  function as() {
    if (Wn) {
      var e = Wn,
        n = $n;
      if ((($n = Wn = null), Gu(e), n)) for (e = 0; e < n.length; e++) Gu(n[e]);
    }
  }
  function cs(e, n) {
    return e(n);
  ...
  function fc(e, n, t, r, l, i, u, o, s) {
    (St = !1), (Mr = null), ac.apply(cc, arguments);
  }
  ...
  function ms(e) {
    return (e = pc(e)), e !== null ? vs(e) : null;
  }
  function vs(e) {
  ...
  var hs = fe.unstable_scheduleCallback,
    Ju = fe.unstable_cancelCallback,
    mc = fe.unstable_shouldYield,
    vc = fe.unstable_requestPaint,
    V = fe.unstable_now,
    hc = fe.unstable_getCurrentPriorityLevel,
    $i = fe.unstable_ImmediatePriority,
    ys = fe.unstable_UserBlockingPriority,
    Or = fe.unstable_NormalPriority,
    yc = fe.unstable_LowPriority,
    gs = fe.unstable_IdlePriority,
    el = null,
    Oe = null;
  function gc(e) {
  ...
  var Ne = Math.clz32 ? Math.clz32 : Sc,
    wc = Math.log,
    kc = Math.LN2;
  function Sc(e) {
  ...
  function Rr(e, n) {
    ...
    if (u !== 0) {
      var o = u & ~l;
      o !== 0 ? (r = gt(o)) : ((i &= u), i !== 0 && (r = gt(i)));
    } else (u = t & ~l), u !== 0 ? (r = gt(u)) : i !== 0 && (r = gt(i));
    if (r === 0) return 0;
    if (
      n !== 0 &&
      n !== r &&
  ...
  function Nc(e, n, t, r, l) {
    switch (n) {
      ...
      case 'pointerover':
        var i = l.pointerId;
        return Dt.set(i, at(Dt.get(i) || null, e, n, t, r, l)), !0;
      case 'gotpointercapture':
        return (
          (i = l.pointerId), Ot.set(i, at(Ot.get(i) || null, e, n, t, r, l)), !0
        );
    }
    return !1;
  }
  ...
  function kr(e) {
    ...
    for (var n = e.targetContainers; 0 < n.length; ) {
      ...
      } else return (n = Xt(t)), n !== null && Yi(n), (e.blockedOn = t), !1;
      n.shift();
    }
    return !0;
  }
  ...
  function ct(e, n) {
    e.blockedOn === n &&
      ...
      ai ||
        ((ai = !0),
        fe.unstable_scheduleCallback(fe.unstable_NormalPriority, Pc)));
  }
  function Rt(e) {
    function n(l) {
      return ct(l, e);
    ...
    for (; 0 < Ze.length && ((t = Ze[0]), t.blockedOn === null); )
      _s(t), t.blockedOn === null && Ze.shift();
  }
  ...
  function Xi(e, n, t, r) {
    if (Fr) {
      var l = ci(e, n, t, r);
      if (l === null) Fl(e, n, r, Ir, t), qu(e, r);
      else if (Nc(l, e, n, t, r)) r.stopPropagation();
      else if ((qu(e, r), n & 4 && -1 < _c.indexOf(e))) {
        for (; l !== null; ) {
          var i = Xt(l);
          if (
            (i !== null && Ss(i),
  ...
  var tt = {
    ...
    nl = I({}, Yt, {
      ...
      movementX: function (e) {
        return 'movementX' in e
          ...
          : (e !== ft &&
              (ft && e.type === 'mousemove'
                ? ((Ll = e.screenX - ft.screenX), (Tl = e.screenY - ft.screenY))
                : (Tl = Ll = 0),
              (ft = e)),
            Ll);
      },
    ...
    no = de(nl),
    Mc = I({}, nl, { dataTransfer: 0 }),
    Dc = de(Mc),
    Oc = I({}, Yt, { relatedTarget: 0 }),
    Ml = de(Oc),
    Rc = I({}, tt, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Fc = de(Rc),
    Ic = I({}, tt, {
  ...
  var Qc = I({}, Yt, {
    ...
    Yc = de(Kc),
    Xc = I({}, tt, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
    Gc = de(Xc),
    Zc = I({}, nl, {
      deltaX: function (e) {
        return 'deltaX' in e
  ...
  var bc = Ae && 'TextEvent' in window && !Et,
    zs = Ae && (!qi || (Et && 8 < Et && 11 >= Et)),
    lo = String.fromCharCode(32),
    io = !1;
  function Ls(e, n) {
    switch (e) {
      case 'keyup':
        return qc.indexOf(n.keyCode) !== -1;
      case 'keydown':
  ...
  function nf(e, n) {
    if (On)
      return e === 'compositionend' || (!qi && Ls(e, n))
        ? ((e = Ps()), (Sr = Gi = qe = null), (On = !1), e)
        : null;
    switch (e) {
      case 'paste':
        return null;
  ...
  Ae &&
    (Ae
      ? ((ar = 'oninput' in document),
        ...
        (sr = ar))
      : (sr = !1),
    (Ds = sr && (!document.documentMode || 9 < document.documentMode)));
  var sr, ar, Dl;
  function oo() {
    Ct && (Ct.detachEvent('onpropertychange', Os), (Ft = Ct = null));
  }
  function Os(e) {
    if (e.propertyName === 'value' && tl(Ft)) {
      var n = [];
      Ms(n, Ft, e, Wi(e)), ds(rf, n);
    }
  }
  function uf(e, n, t) {
    e === 'focusin'
      ? (oo(), (Ct = n), (Ft = t), Ct.attachEvent('onpropertychange', Os))
      : e === 'focusout' && oo();
  }
  function of(e) {
  ...
  var ze = typeof Object.is == 'function' ? Object.is : cf;
  function It(e, n) {
    if (ze(e, n)) return !0;
    if (
      typeof e != 'object' ||
  ...
  var df = Ae && 'documentMode' in document && 11 >= document.documentMode,
    Rn = null,
    fi = null,
    xt = null,
    di = !1;
  ...
  function rl(e) {
    ...
    var n = Fn[e],
      t;
    for (t in n) if (n.hasOwnProperty(t) && t in Is) return (Ol[e] = n[t]);
    return e;
  }
  var js = rl('animationend'),
    Us = rl('animationiteration'),
  ...
  for (fr = 0; fr < fo.length; fr++)
    (dr = fo[fr]),
      (po = dr.toLowerCase()),
      (mo = dr[0].toUpperCase() + dr.slice(1)),
      fn(po, 'on' + mo);
  var dr, po, mo, fr;
  fn(js, 'onAnimationEnd');
  fn(Us, 'onAnimationIteration');
  fn(Vs, 'onAnimationStart');
  fn('dblclick', 'onDoubleClick');
  fn('focusin', 'onFocus');
  fn('focusout', 'onBlur');
  fn(As, 'onTransitionEnd');
    ...
    if (!e[pr]) {
      (e[pr] = !0),
        Zo.forEach(function (t) {
          t !== 'selectionchange' && (pf.has(t) || Rl(t, !1, e), Rl(t, !0, e));
        });
          ...
          for (var a = d, f; a !== null; ) {
            ...
            if (
              (f.tag === 5 &&
                ...
                ((f = y),
                c !== null &&
                  ((y = Mt(a, c)), y != null && S.push(Ut(a, y, f)))),
              U)
            )
              break;
            a = a.return;
        ...
        _ &&
          (zs &&
            ...
            (On || _ !== 'onCompositionStart'
              ? _ === 'onCompositionEnd' && On && (x = Ps())
              : ((qe = m),
                (Gi = 'value' in qe ? qe.value : qe.textContent),
                (On = !0))),
          (C = jr(d, _)),
          0 < C.length &&
            ((_ = new to(_, e, null, t, m)),
            v.push({ event: _, listeners: C }),
            x ? (_.data = x) : ((x = Ts(t)), x !== null && (_.data = x)))),
          (x = bc ? ef(e, t) : nf(e, t)) &&
            ((d = jr(d, 'onBeforeInput')),
            0 < d.length &&
              ((m = new to('onBeforeInput', 'beforeinput', null, t, m)),
  ...
  function ho(e, n, t, r, l) {
    for (var i = n._reactName, u = []; t !== null && t !== r; ) {
      ...
      o.tag === 5 &&
        ...
        ((o = d),
        l
          ? ((s = Mt(t, i)), s != null && u.unshift(Ut(t, s, o)))
          : l || ((s = Mt(t, i)), s != null && u.push(Ut(t, s, o)))),
        (t = t.return);
    }
...
`
  ...
  function mr(e, n, t) {
    if (((n = yo(n)), yo(e) !== n && t)) throw Error(h(425));
  }
  function Ur() {}
  var pi = null,
    mi = null;
  ...
  var hi = typeof setTimeout == 'function' ? setTimeout : void 0,
    ...
    yf =
      typeof queueMicrotask == 'function'
        ...
        : typeof go < 'u'
        ? function (e) {
            return go.resolve(null).then(e).catch(gf);
          }
        : hi;
  function gf(e) {
    setTimeout(function () {
  ...
  var rt = Math.random().toString(36).slice(2),
    ...
    yi = '__reactEvents$' + rt,
    wf = '__reactListeners$' + rt,
    kf = '__reactHandles$' + rt;
  function yn(e) {
    var n = e[De];
    if (n) return n;
  ...
  function Ws(e, n, t) {
    ...
    if (((n = n.childContextTypes), typeof r.getChildContext != 'function'))
      return t;
    r = r.getChildContext();
    for (var l in r) if (!(l in n)) throw Error(h(108, ic(e) || 'Unknown', l));
    return I({}, t, r);
  }
  function Ar(e) {
    return (
  ...
  function pn() {
    if (!jl && Ie !== null) {
      ...
      try {
        ...
        throw (Ie !== null && (Ie = Ie.slice(e + 1)), hs($i, pn), l);
      } finally {
        (z = n), (jl = !1);
      }
    }
  ...
  function vr(e) {
    ...
    if (
      ...
      if (wi(e)) throw (Xs(), Error(h(418)));
      for (; n; ) Ys(e, n), (n = rn(n.nextSibling));
    }
    if ((Co(e), e.tag === 13)) {
  ...
  var Ef = We.ReactCurrentBatchConfig;
  function Ce(e, n) {
    if (e && e.defaultProps) {
  ...
  function Ci(e, n, t, r) {
    var l = e.stateNode;
    (l.props = t), (l.state = e.memoizedState), (l.refs = Js), ou(e);
    var i = n.contextType;
    typeof i == 'object' && i !== null
      ? (l.context = we(i))
  ...
  function bs(e) {
        ...
        : a !== null &&
          (a.elementType === E ||
            (typeof E == 'object' &&
              ...
              E.$$typeof === Xe &&
              zo(E) === a.type))
        ? ((y = l(a, f.props)), (y.ref = dt(c, a, f)), (y.return = c), y)
    ...
    function p(c, a, f, y) {
      ...
      if (typeof f == 'object' && f !== null) {
        ...
        if (yt(f) || st(f)) return E !== null ? null : m(c, a, f, y, null);
        hr(c, f);
      }
      return null;
    }
    function g(c, a, f, y, E) {
      ...
      if (typeof y == 'object' && y !== null) {
        ...
        if (yt(y) || st(y)) return (c = c.get(f) || null), m(a, c, y, E, null);
        hr(a, y);
      }
      return null;
    }
  ...
  function su(e, n) {
    switch ((T(Bt, n), T(At, e), T(Re, Gt), (e = n.nodeType), e)) {
      case 9:
      case 11:
  ...
  function du(e, n, t, r, l, i) {
    if (
      ...
      (n.updateQueue = null),
      (n.lanes = 0),
      (xr.current = e === null || e.memoizedState === null ? Pf : zf),
      (e = t(r, l)),
      _t)
    ) {
      i = 0;
  ...
  function ra(e, n) {
    ...
    if (
      ...
      (r = r.queue),
      mu(ua.bind(null, t, r, e), [e]),
      r.getSnapshot !== n || i || (W !== null && W.memoizedState.tag & 1))
    ) {
      if (
        ((t.flags |= 2048),
        Wt(9, ia.bind(null, t, r, l, n), void 0, null),
        $ === null)
      )
        throw Error(h(349));
      xn & 30 || la(t, n, l);
  ...
  function ia(e, n, t, r) {
    (n.value = t), (n.getSnapshot = r), oa(n) && sa(e);
  }
  function ua(e, n, t) {
    return t(function () {
      oa(n) && sa(e);
  ...
  function ol(e, n, t, r) {
    ...
    (F.flags |= e), (l.memoizedState = Wt(1 | n, t, i, r));
  }
  function To(e, n) {
  ...
  function pa(e, n, t) {
    return (
      (t = t != null ? t.concat([e]) : null), ol(4, 4, da.bind(null, n, e), t)
    );
  }
  function vu() {}
  function ma(e, n) {
  ...
  function ha(e, n, t) {
    return xn & 21
      ? (ze(t, n) ||
          ((t = ws()), (F.lanes |= t), (_n |= t), (e.baseState = !0)),
        n)
  ...
  function Nf(e, n, t) {
    ...
    if (ga(e)) wa(n, l);
      ...
      (t = Gs(e, n, l, r)),
        t !== null && ((l = ne()), Pe(t, e, r, l), ka(t, n, r));
    }
  }
  function ga(e) {
    var n = e.alternate;
  ...
  var Xr = {
    ...
    Pf = {
      ...
      useImperativeHandle: function (e, n, t) {
        return (
          ...
          _r(4194308, 4, da.bind(null, n, e), t)
        );
      },
      ...
      useTransition: function () {
        var e = Lo(!1),
          n = e[0];
        return (e = xf.bind(null, e[1])), (Me().memoizedState = e), [n, e];
      },
      ...
      useSyncExternalStore: function (e, n, t) {
        ...
        return (
          (l.queue = i),
          To(ua.bind(null, r, i, e), [e]),
          (r.flags |= 2048),
          Wt(9, ia.bind(null, r, i, t, n), void 0, null),
          t
        );
      },
      useId: function () {
    ...
    Lf = {
      ...
      useDeferredValue: function (e) {
        var n = ke();
        return B === null ? (n.memoizedState = e) : ha(n, B.memoizedState, e);
      },
      useTransition: function () {
        var e = Bl(Qt)[0],
          n = ke().memoizedState;
...
` +
  ...
  var Mf = We.ReactCurrentOwner,
    le = !1;
  function ee(e, n, t, r) {
    n.child = e === null ? ea(n, null, t, r) : qn(n, e.child, t, r);
  }
  ...
  function Fo(e, n, t, r, l) {
    if (e === null) {
      ...
      return typeof i == 'function' &&
        ...
        ? ((n.tag = 15), (n.type = i), Ca(e, n, i, r, l))
  ...
  function Io(e, n, t, r, l) {
    ...
    if ((Yn(n, l), n.stateNode === null))
      Nr(e, n), qs(n, t, r), Ci(n, t, r, l), (r = !0);
    else if (e === null) {
      var u = n.stateNode,
        o = n.memoizedProps;
      u.props = o;
  ...
  function Ni(e, n, t, r, l, i) {
    _a(e, n);
    var u = (n.flags & 128) !== 0;
    if (!r && !u) return l && So(n, t, !1), Qe(e, n, i);
    ...
    switch ((nu(n), n.tag)) {
        ...
        if (((t = n.type), e !== null && n.stateNode != null))
          ...
          if (((e = wn(Re.current)), vr(n))) {
            ...
            switch (((r[De] = n), (r[Vt] = i), (e = (n.mode & 1) !== 0), t)) {
              ...
              case 'video':
              case 'audio':
                for (l = 0; l < wt.length; l++) M(wt[l], r);
                break;
              case 'source':
                M('error', r);
                break;
            ...
            e: {
              switch (((u = ri(t, r)), t)) {
                ...
                case 'video':
                case 'audio':
                  for (l = 0; l < wt.length; l++) M(wt[l], e);
                  l = r;
                  break;
                case 'source':
                  M('error', e), (l = r);
      ...
      case 6:
        if (e && n.stateNode != null) Ma(e, n, e.memoizedProps, r);
          ...
          if (((t = wn(Bt.current)), wn(Re.current), vr(n))) {
            if (
              ((r = n.stateNode),
              (t = n.memoizedProps),
              (r[De] = n),
      ...
      case 19:
        ...
        if (((r = (n.flags & 128) !== 0), (u = i.rendering), u === null))
          if (r) pt(i, !1);
            ...
            i.tail !== null &&
              V() > nt &&
              ((n.flags |= 128), (r = !0), pt(i, !1), (n.lanes = 4194304));
          }
        else {
          if (!r)
            if (((e = Kr(u)), e !== null)) {
      ...
      case 5:
        ...
        if (r & 4 && ((l = e.stateNode), l != null)) {
          ...
          if (((e.updateQueue = null), s !== null))
            try {
              o === 'input' && i.type === 'radio' && i.name != null && ts(l, i),
                ri(o, u);
              var d = ri(o, i);
  ...
  function Pe(e, n, t, r) {
    if (50 < zt) throw ((zt = 0), (Fi = null), Error(h(185)));
    Kt(e, t, r),
      (!(N & 2) || e !== $) &&
  ...
  function oe(e, n) {
    ...
    if (r === 0)
      ...
      if ((t != null && Ju(t), n === 1))
        e.tag === 0 ? Sf($o.bind(null, e)) : $s($o.bind(null, e)),
          yf(function () {
            !(N & 6) && pn();
          }),
          (t = null);
  ...
  function ja(e, n) {
    ...
    if (n !== 0) {
      if (
        ...
        throw ((t = $t), kn(e, 0), Je(e, r), oe(e, V()), t);
      if (n === 6) Je(e, r);
      else {
        if (
    ...
    return oe(e, V()), e.callbackNode === t ? ja.bind(null, e) : null;
  }
  function Ii(e, n) {
    var t = Pt;
    return (
  ...
  function $o(e) {
    ...
    if (t === 1) throw ((t = $t), kn(e, 0), Je(e, n), oe(e, V()), t);
  ...
  function kn(e, n) {
    ...
    if ((t !== -1 && ((e.timeoutHandle = -1), hf(t)), A !== null))
  ...
  function Ha(e, n) {
    n === 0 &&
      (e.mode & 1
        ...
        : (n = 1));
    var t = ne();
    (e = He(e, n)), e !== null && (Kt(e, n, t), oe(e, t));
  }
  function $f(e) {
    var n = e.memoizedState,
      t = 0;
  ...
  Qa = function (e, n, t) {
    if (e !== null)
      if (e.memoizedProps !== n.pendingProps || ie.current) le = !0;
        ...
        if (!(e.lanes & t) && !(n.flags & 128)) return (le = !1), Of(e, n, t);
        le = !!(e.flags & 131072);
      }
    else (le = !1), O && n.flags & 1048576 && Ks(n, Hr, n.index);
    switch (((n.lanes = 0), n.tag)) {
      ...
      case 3:
        e: {
          if ((Na(n), e === null)) throw Error(h(387));
          (r = n.pendingProps),
            (i = n.memoizedState),
            (l = i.element),
            Zs(e, n),
          ...
          if (((r = u.element), i.isDehydrated))
            if (
              ...
              (l = et(Error(h(423)), n)), (n = jo(e, n, r, t, l));
              break e;
            } else if (r !== l) {
              (l = et(Error(h(424)), n)), (n = jo(e, n, r, t, l));
              break e;
            } else
              for (
  ...
  function qf(e, n, t, r, l) {
    ...
    var s = xu(e, 0, !1, null, null, !1, !1, '', Xo);
    return (
  ...
  cs = ku;
  fs = Nn;
  var bf = { usingClientEntryPoint: !1, Events: [Xt, In, ll, ss, as, ku] },
    mt = {
    ...
    ed = {
      ...
      findFiberByHostInstance: mt.findFiberByHostInstance || Jf,
  ...
  pe.hydrateRoot = function (e, n, t) {
    ...
    if (
      ...
      (n = Ka(n, null, e, 1, t ?? null, l, !1, i, u)),
      (e[Be] = n.current),
      jt(e),
      r)
    )
