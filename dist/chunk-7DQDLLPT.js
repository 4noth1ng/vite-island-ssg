...
var SKIP = "skip";
var EXIT = false;
var visitParents = function(tree2, test, visitor, reverse) {
...
var visit = function(tree2, test, visitor, reverse) {
  if (typeof test === "function" && typeof visitor !== "function") {
    reverse = visitor;
    visitor = test;
    test = null;
...
exports.PACKAGE_ROOT = PACKAGE_ROOT; exports.CLIENT_ENTRY_PATH = CLIENT_ENTRY_PATH; exports.SERVER_ENTRY_PATH = SERVER_ENTRY_PATH; exports.MASK_SPLITTER = MASK_SPLITTER; exports.EXTERNALS = EXTERNALS; exports.createVitePlugins = createVitePlugins;
